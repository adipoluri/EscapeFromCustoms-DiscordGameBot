    ...
    con.connect(function (err) {
      ...
      con.query("Select * FROM PlayerStats", function (err, result) {
        ...
        con.query("Select * FROM Equipment", function (err, result2) {
          ...
          if (alreadyinraid) {
            var inventory = [
              result2[userIndex].Slot1,
              result2[userIndex].Slot2,
              result2[userIndex].Slot3,
              result2[userIndex].Slot4,
            ];
            var image =
              profilePictures[
            ...
            const Embed = new Discord.MessageEmbed()
              ...
              .addFields(
                ...
                { name: "Your Stats", value: "-------------------" },
                {
                  ...
                  value: result[userIndex].STR,
                  inline: true,
                },
                {
                  name: "DEXTERITY :raised_hand:",
                  value: result[userIndex].DEX,
                  inline: false,
                },
                {
                  name: "PERCEPTION :eye:",
                  value: result[userIndex].PERC,
                  inline: true,
                },
                {
                  name: "PRECISION :gun:",
                  value: result[userIndex].PREC,
                  inline: false,
                }
              )
            ...
            message.reply(
              "You are not Registered! Use !Register now you simp!"
            );
          }
        });
      });
